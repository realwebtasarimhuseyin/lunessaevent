...
<head>
    ...
    <title>NORTHERN - İletişim Mesajı</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="email-header">
            ...
            <p>Bir müşteri sizinle iletişime geçti</p>
        </div>
        <div class="email-body">
            <h2>İletişim Detayları:</h2>
            <p><strong>Ad Soyad:</strong> {{ $veriler['isim'] }}</p>
            <p><strong>E-Posta:</strong> {{ $veriler['eposta'] }}</p>
