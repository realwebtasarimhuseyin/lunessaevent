<x-layout.admin :scrollspy="false">
    ...
    @include('admin.urunvaryantozellik.partials.form',["btnText" => "Ürün Varyant Özellik Ekle"])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/urunVaryantOzellik/ekle.js'])
    </x-slot>
