<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('realpanel.urunvaryant.index') }}">Ürün Varyant Özellik</a></li>
    ...
    @include('admin.urunvaryantozellik.partials.form',["btnText" => "Ürün Varyant Özellik Düzenle"])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/urunVaryantOzellik/duzenle.js'])
    </x-slot>
