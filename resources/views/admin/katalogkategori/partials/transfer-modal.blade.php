    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="modal-text">
                    Seçtiğiniz kategori, mevcut ürünlerle ilişkilendirilmiştir ve bu nedenle doğrudan silinememektedir.
                    Kategoriyi silmeden önce, o kategoriye bağlı tüm ürünlerin başka bir kategoriye aktarılması
                    gerekmektedir.
                </p>
                <br>
                <div class="form-group row mb-4">
                    <label for="transferKategori">Ürünlerin Transfer Edileceği Yeni Kategori</label>
