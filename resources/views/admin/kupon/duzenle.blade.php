<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('realpanel.kupon.index') }}">Kupon</a></li>
                <li class="breadcrumb-item active" aria-current="page">Düzenle</li>
            </ol>
        </nav>
    </div>

    @include('admin.kupon.partials.form', ['btnText' => 'Kupon Düzenle'])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/kupon/duzenle.js'])
    </x-slot>
