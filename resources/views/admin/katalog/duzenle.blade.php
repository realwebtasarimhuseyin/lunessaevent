<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('realpanel.katalog.index') }}">Katalog</a></li>
                <li class="breadcrumb-item active" aria-current="page">Düzenle</li>
            </ol>
        </nav>
    </div>

    @include('admin.katalog.partials.form', ['btnText' => 'Katalog Düzenle'])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/katalog/duzenle.js'])
    </x-slot>
</x-layout.admin>
