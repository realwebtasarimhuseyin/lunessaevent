    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="modal-text">
                    Seçtiğiniz kategori, mevcut hizmetlerle ilişkilendirilmiştir ve bu nedenle doğrudan silinememektedir.
                    Kategoriyi silmeden önce, o kategoriye bağlı tüm hizmetlerin başka bir kategoriye aktarılması
                    gerekmektedir.
                </p>
                <br>
                <div class="form-group row mb-4">
                    <label for="transferKategori">Hizmetlerin Transfer Edileceği Yeni Kategori</label>
