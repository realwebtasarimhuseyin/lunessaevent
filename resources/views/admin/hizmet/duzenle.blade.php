<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('realpanel.hizmet.index')}}">Hizmet</a></li>
                <li class="breadcrumb-item active" aria-current="page">Düzenle</li>
            </ol>
        </nav>
    </div>

    @include('admin.hizmet.partials.form', ['btnText' => 'Hizmet Düzenle'])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/hizmet/duzenle.js'])
    </x-slot>
