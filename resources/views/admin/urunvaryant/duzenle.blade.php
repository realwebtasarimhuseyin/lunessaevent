<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('realpanel.urunvaryant.index')}}">Ürün Varyant</a></li>
    ...
    @include('admin.urunvaryant.partials.form',["btnText" => "Ürün Varyant Düzenle"])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/urunVaryant/duzenle.js'])
    </x-slot>
