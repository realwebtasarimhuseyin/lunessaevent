<x-layout.admin :scrollspy="false">
    ...
    <div class="row layout-top-spacing">
        ...
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <table id="urunKategoriDataTable" class="table dt-table-hover" style="width:100%">
                    <thead>
                        <tr>
                            <th>Sıra No</th>
    ...
    @include('admin.urunkategori.partials.transfer-modal')
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/urunKategori/index.js'])
    </x-slot>
