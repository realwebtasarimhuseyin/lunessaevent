<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">Ürün Ozellik</li>
    ...
    <div class="row layout-top-spacing">
        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
            <div class="widget-content widget-content-area br-8">
                <table id="urunOzellikDataTable" class="table dt-table-hover" style="width:100%">
                    <thead>
                        <tr>
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/urunOzellik/index.js'])
    </x-slot>
</x-layout.admin>
