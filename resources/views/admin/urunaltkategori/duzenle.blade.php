<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('realpanel.urunaltkategori.index')}}">Ürün Alt Kategori</a></li>
    ...
    @include('admin.urunaltkategori.partials.form',["btnText" => "Ürün Alt Kategori Düzenle"])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/urunAltKategori/duzenle.js'])
    </x-slot>
