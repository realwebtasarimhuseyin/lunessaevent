<x-layout.admin :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('realpanel.sayfayonetim.index')}}">Sayfa Yönetim</a></li>
                <li class="breadcrumb-item active" aria-current="page">Düzenle</li>
            </ol>
        </nav>
    </div>

    @include('admin.sayfayonetim.partials.form',["btnText" => "Sayfa Yönetim Düzenle"])
    ...
    <x-slot:footerFiles>
        ...
        @vite(['resources/js/pages/admin/sayfaYonetim/duzenle.js'])
    </x-slot>
