<x-layout.web>
    <x-slot:baslik>
        {{ ayar('siteBaslik', $aktifDil) }} | {{ __('global.bloglar') }}
    </x-slot>
    <x-slot:aciklama>
        ...
        <div class="container py-5">
            <div class="row py-5">
                <div class="col-lg-8 mx-auto text-center">
                    <h1 class="display-4 fw-bold mb-3">Kılavuz</h1>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a href="{{ rota('index') }}" class="text-white">Anasayfa</a>
                            </li>
                            <li class="breadcrumb-item active text-white" aria-current="page">Kılavuz</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="blog-card-alpha">
                            <div class="blog-thumb">
                                <a href="{{ rota('blog-detay', ['slug' => $blogDilVerisi->slug]) }}">
                                    <img src="{{ depolamaUrl($blog) }}" alt="" />
                                </a>

                                <div class="blog-lavel">
                                    <a href="{{ rota('blog-detay', ['slug' => $blogDilVerisi->slug]) }}">
                                        <i class="bi bi-calendar3"></i> {{ formatZaman($blog->created_at, 'yil') }}
                                    </a>
                                </div>
                            </div>
