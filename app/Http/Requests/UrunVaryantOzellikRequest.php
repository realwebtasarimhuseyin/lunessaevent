...
class UrunVaryantOzellikRequest extends FormRequest
{
    /**
     * 
     * @return bool
    ...
    public function messages(): array
    {
        ...
        $messages = [];
        foreach ($diller as $dil) {
            $messages["isim_{$dil}.required"] = 'Ürün Varyant Özellik isim (' . $dil . ') alanı boş bırakılamaz.';
            $messages["isim_{$dil}.max"] = 'Ürün Varyant Özellik isim (' . $dil . ') en fazla 150 karakter olabilir.';
        }
        return $messages;
    }
}
