...
class ProjeRequest extends FormRequest
{
    /**
     * 
     * @return bool
    ...
    public function messages(): array
    {
        ...
        foreach ($diller as $dil) {
            ...
            if ($dilEnum) {
                ...
                $messages["baslik_{$dil}.required"] = 'Proje başlığı (' . $dilValue . ') alanı boş bırakılamaz.';
                $messages["baslik_{$dil}.max"] = 'Proje başlığı (' . $dilValue . ') en fazla 255 karakter olabilir.';
                ...
                $messages["metaBaslik_{$dil}.max"] = 'Meta başlığı (' . $dilValue . ') en fazla 255 karakter olabilir.';
                ...
                $messages["metaAnahtar_{$dil}.max"] = 'Meta anahtar (' . $dilValue . ') en fazla 255 karakter olabilir.';
            }
        }
        return $messages;
    }
