...
class KatalogKategori extends Model
{
     ...
     * @var string
     */
    protected $table = 'katalog_kategori';
     ...
     */
    public function katalogKategoriDiller()
    {
        return $this->hasMany(KatalogKategoriDil::class, 'katalog_kategori_id', 'id');
    }

    public function katalogler()
    {
        return $this->hasMany(Katalog::class, 'katalog_kategori_id', 'id');
    }
    ...
    public static function slugUret(string $baslik)
    {
        ...
        while (
            self::whereHas('katalogKategoriDiller', function ($query) use ($slug) {
